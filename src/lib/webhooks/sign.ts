...
//
// Every delivery carries an `X-OctaCRM-Signature` header so receivers
// can verify the request really came from OctaCRM and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-OctaCRM-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-OctaCRM-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so an OctaCRM-to-OctaCRM integration
