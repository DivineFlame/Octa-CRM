...
//
// Why the `octacrm_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     an OctaCRM key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `octacrm_test_` variant if
...
export const API_KEY_PREFIX = 'octacrm_live_';
