...
- [GitHub Security Advisories](https://github.com/DivineFlame/Octa-CRM/security/advisories/new)
...
In scope:
- Anything in this repository (`DivineFlame/Octa-CRM`), including webhook and auth
